...
export default class CardList {
    ...
    init() {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            switch (e.key) {
                ...
                case ' ': {
                    e.preventDefault();
                    this.openEditForm(card, card.formId);
                    break;
                }
                case 'Delete':
                case 'Backspace': {
    ...
    parseCard(cardData, wrapperId, formId) {
        ...
        <button class="svg_btn delete" aria-label="Удалить запись">
        ...
        <button class="svg_btn" aria-label="Переместить запись">
        ...
        if (checkbox && endInput) {
            const toggle = () => {
                if (checkbox.checked) {
                    ...
                    endInput.setAttribute('aria-disabled', 'false');
                }
            };
    ...
    loadFromStorage() {
        ...
        Object.keys(data).forEach(wrapperId => {
            ...
            cards.forEach(cardObj => {
                ...
                this.parseCard(cardObj.data, wrapperId, cardObj.form);
            });
        });
    }
}